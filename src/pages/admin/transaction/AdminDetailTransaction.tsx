...
const AdminDetailTransaction: React.FC = () => { 
  const {id} = useParams()
  ...
  return (
    <>
      ...
      <Link className="bg-sky-600 text-white text-xs px-8 py-2 rounded-md absolute top-20 right-40 font-bold inline-block" to="/admin/transaction">Back</Link>
